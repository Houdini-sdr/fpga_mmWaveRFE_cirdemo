...
# 7.68 MHz PL SYS REFCLK -- LMK OUT9 
set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "pl_rf_sysref_clk_p" ]
set_property PACKAGE_PIN AP18      [get_ports "pl_rf_sysref_clk_p"] ;# Bank 66 - HP, MAX 1V8

set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "pl_rf_sysref_clk_n" ]
set_property PACKAGE_PIN AR18      [get_ports "pl_rf_sysref_clk_n"] ;# Bank 66 - HP, MAX 1V8

# 7.68 MHz RF DAC/ADC REFCLK -- LMK OUT3
set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "rf_sysref_diff_p" ]
set_property PACKAGE_PIN U5      [get_ports "rf_sysref_diff_p"] ; # Bank 228

set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "rf_sysref_diff_n" ]
set_property PACKAGE_PIN U4      [get_ports "rf_sysref_diff_n"] ; # Bank 228

# 122.88 MHz PL Clock -- LMK OUT8
set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "fpga_refclk_in_clk_p" ]
set_property PACKAGE_PIN AN11      [get_ports "fpga_refclk_in_clk_p"] ;# Bank 65 - HP, MAX 1V8

set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "fpga_refclk_in_clk_n" ]
set_property PACKAGE_PIN AP11      [get_ports "fpga_refclk_in_clk_n"] ;# Bank 65 - HP, MAX 1V8

# 491.52 MHz RF ADC clock, Bank 224
set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "adc0_clk_clk_p" ]
set_property PACKAGE_PIN AF5      [get_ports "adc0_clk_clk_p"] ; 

set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "adc0_clk_clk_n" ]
set_property PACKAGE_PIN AF4      [get_ports "adc0_clk_clk_n"] ;

# 491.52 MHz RF DAC clock, Bank 228
set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "dac0_clk_clk_p" ]
set_property PACKAGE_PIN R5      [get_ports "dac0_clk_clk_p"] ;

set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "dac0_clk_clk_n" ]
set_property PACKAGE_PIN R4      [get_ports "dac0_clk_clk_n"] ; 

# 491.52 MHz RF DAC clock, Bank 230
set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "dac2_clk_clk_p" ]
set_property PACKAGE_PIN N5      [get_ports "dac2_clk_clk_p"] ;

set_property IOSTANDARD DIFF_SSTL18_I [ get_ports "dac2_clk_clk_n" ]
set_property PACKAGE_PIN N4      [get_ports "dac2_clk_clk_n"] ; 
...
set_property IOSTANDARD LVCMOS18 [ get_ports "ctrl_ch1"]

#set_property PACKAGE_PIN AK17 [ get_ports "PMOD0_3" ]
set_property PACKAGE_PIN AK17 [ get_ports "ctrl_ch2" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "ctrl_ch2"]
...
set_property IOSTANDARD LVCMOS18 [ get_ports "ctrl_ch3"]

#set_property PACKAGE_PIN AV13 [ get_ports "PMOD1_3" ]
set_property PACKAGE_PIN AV13 [ get_ports "ctrl_ch4" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "ctrl_ch4"]
...
#set_property PACKAGE_PIN AR11 [get_ports pkt_detect]
#set_property IOSTANDARD LVCMOS18 [get_ports pkt_detect]

#set_property PACKAGE_PIN AW10 [ get_ports "W_LED_1" ]
#set_property IOSTANDARD LVCMOS18 [ get_ports "W_LED_1" ]
#set_property PACKAGE_PIN AW10 [get_ports bdry_detect]
#set_property IOSTANDARD LVCMOS18 [get_ports bdry_detect]

#set_property PACKAGE_PIN AT11 [ get_ports "W_LED_2" ]
#set_property IOSTANDARD LVCMOS18 [ get_ports "W_LED_2" ]
#set_property PACKAGE_PIN AT11 [get_ports CIR_calc_start]
#set_property IOSTANDARD LVCMOS18 [get_ports CIR_calc_start]

#set_property PACKAGE_PIN AU10 [ get_ports "W_LED_3" ]
#set_property IOSTANDARD LVCMOS18 [ get_ports "W_LED_3" ]
#set_property PACKAGE_PIN AU10 [get_ports {LED_ref[0]}]
#set_property IOSTANDARD LVCMOS18 [get_ports {LED_ref[0]}]

## USER PUSH BUTTON
#set_property PACKAGE_PIN AV12 [ get_ports "PB_0" ]
#set_property IOSTANDARD LVCMOS18 [ get_ports "PB_0" ]
#set_property PACKAGE_PIN AV12 [ get_ports "reset_rtl" ]
...
#set_property MARK_DEBUG true [get_nets cir_est_i/CIR_Extract_1x1_Tx_t_0_BD_real]
#set_property MARK_DEBUG true [get_nets cir_est_i/CIR_Extract_1x1_Tx_t_0_PD_real]
#set_property MARK_DEBUG true [get_nets cir_est_i/CIR_Extract_1x1_Tx_t_0_PD_real]
